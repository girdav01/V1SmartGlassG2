...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Hey Even, hacker news", Intent.NEWS_HACKER),
        ("Hey Even latest HN stories", Intent.NEWS_HACKER),
        ("Hey Even, security news", Intent.NEWS_SECURITY),
        ("Hey Even cybersecurity news please", Intent.NEWS_SECURITY),
        ("Hey Even, infosec news", Intent.NEWS_SECURITY),
        ("Hey Even, threat intel", Intent.NEWS_SECURITY),
        ("Hey Even, my Medium", Intent.NEWS_MEDIUM),
        ("Hey Even, medium articles", Intent.NEWS_MEDIUM),
        ("Hey Even, daily medium", Intent.NEWS_MEDIUM),
